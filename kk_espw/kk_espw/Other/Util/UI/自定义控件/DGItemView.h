...
/** layerIndicator的高度scale, 默认为0.7, 范围0.1~1.0 */
@property (nonatomic,assign) CGFloat layerIndicatorHeightScale;

/** lineIndicator与itemView的底部的间隙,默认为0, 范围0~itemView的高度 */
@property (nonatomic,assign) CGFloat lineIndicatorBottomSpace;

/** lineIndicator的高度,默认为2.0, 范围0~itemView高度的一半 */
@property (nonatomic,assign) CGFloat lineIndicatorHeight;

/** lineIndicator的圆角,默认为0, 范围0~lineIndicatorHeight高度的一半 */
