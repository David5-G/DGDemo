...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        _titleL.font = [KKFont pingfangFontStyle:PFFontStyleRegular size:RH(11)];
        ...
        _compereL.font = [KKFont pingfangFontStyle:PFFontStyleRegular size:RH(11)];
...
- (void)setTitle:(NSString *)title Name:(NSString *)name ImgUrl:(NSString *)imgUrl {
    [_headerImage sd_setImageWithURL:Url(imgUrl) placeholderImage:Img(@"default_hostName_bg")];
    _titleL.text = title;
    if (name.length == 0) {
