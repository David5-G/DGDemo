...
#define kCellIdStr @"KKLiveStudioMicRankCell"

@interface KKChatRoomMicRankUserListView ()<UITableViewDelegate,UITableViewDataSource>
@property (nonatomic, strong) UITableView *tableView;
@property (nonatomic, strong) NoContentReminderView *notDateView;
@property (nonatomic, copy) KKChatRoomUserListConfigBlock configBlock;
@property (nonatomic, copy) KKChatRoomUserListSelectBlock selectBlock;
@end

@implementation KKChatRoomMicRankUserListView
...
-(UITableView *)tableView {
    if (!_tableView) {
        ...
        [_tableView registerClass:[KKChatRoomMicRankCell class] forCellReuseIdentifier:kCellIdStr];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    KKChatRoomMicRankCell *cell = [tableView dequeueReusableCellWithIdentifier:kCellIdStr forIndexPath:indexPath];
...
-(void)setIsHostCheck:(BOOL)isHostCheck {
    ...
    CGFloat rightSpace = isHostCheck ? 0 : [ccui getRH:20];
    self.tableView.showsVerticalScrollIndicator = !isHostCheck;
    self.tableView.scrollIndicatorInsets = UIEdgeInsetsMake(0, 0, 0, rightSpace);
}
@end
