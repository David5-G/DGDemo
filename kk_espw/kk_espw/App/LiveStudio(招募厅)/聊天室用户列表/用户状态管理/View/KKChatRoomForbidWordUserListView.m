...
@interface KKChatRoomForbidWordUserListView ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation KKChatRoomForbidWordUserListView
...
-(UITableView *)tableView {
    if (!_tableView) {
        ...
        [_tableView registerClass:[KKChatRoomForbidWordCell class] forCellReuseIdentifier:kCellIdStr];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    KKChatRoomForbidWordCell *cell = [tableView dequeueReusableCellWithIdentifier:kCellIdStr forIndexPath:indexPath];
