//
//  KKLiveStudioOnlineUserListView.m
//  kk_espw
//
...
#define kOnlineUserCell @"KKLiveStudioOnlineUserCell"

@interface KKChatRoomOnlineUserListView ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation KKChatRoomOnlineUserListView
...
-(UITableView *)tableView {
    if (!_tableView) {
        ...
        [_tableView registerClass:[KKChatRoomOnlineUserCell class] forCellReuseIdentifier:kOnlineUserCell];
    }
    return _tableView;
}
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    KKChatRoomOnlineUserCell *cell = [tableView dequeueReusableCellWithIdentifier:kOnlineUserCell forIndexPath:indexPath];
