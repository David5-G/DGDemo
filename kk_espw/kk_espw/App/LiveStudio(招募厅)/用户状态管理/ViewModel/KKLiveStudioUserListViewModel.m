...
#import "KKLiveStudioUserListViewModel.h"


@interface KKLiveStudioUserListViewModel ()

@end

@implementation KKLiveStudioUserListViewModel

#pragma mark - lazy load
-(NSMutableArray<KKLiveStudioUserSimpleModel *> *)onlineUsers {
    if (!_onlineUsers) {
...
-(NSMutableArray<KKLiveStudioUserSimpleModel *> *)forbidWordUsers {
    if (!_forbidWordUsers) {
...
-(void)requestOnlineUsers:(KKLiveStudioUserListBlock)success {
    ...
    [[CC_HttpTask getInstance] post:[KKNetworkConfig currentUrl] params:params model:nil finishCallbackBlock:^(NSString *error, ResModel *resModel) {
        ...
        NSArray <KKLiveStudioUserSimpleModel *>*modelUsers = [KKLiveStudioUserSimpleModel mj_objectArrayWithKeyValuesArray:dicUsers];
...
-(void)requestMicRankUsers:(KKLiveStudioUserListBlock)success {
    ...
    [[CC_HttpTask getInstance] post:[KKNetworkConfig currentUrl] params:params model:nil finishCallbackBlock:^(NSString *error, ResModel *resModel) {
        ...
        if (error) {
            ...
            strongSelf.micRankUsers = [KKLiveStudioUserSimpleModel mj_objectArrayWithKeyValuesArray:dicUsers];
            //是否在mic上
...
#pragma mark - tool
-(void)triggerBlock:(_Nullable KKLiveStudioUserListBlock)block byCode:(NSInteger)code {
    if (block) {
        block(code);
    }
}
