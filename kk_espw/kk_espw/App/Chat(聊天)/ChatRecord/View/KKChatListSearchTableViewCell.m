...
- (void)createSubViews {
    ...
    //2.nameL
    DGLabel *nameL = [DGLabel labelWithText:@"" fontSize:[ccui getRH:16] color:[UIColor blackColor]];
    ...
    //3.msgCountL
    DGLabel *msgCountL = [DGLabel labelWithText:@"" fontSize:[ccui getRH:14] color:[UIColor grayColor]];
