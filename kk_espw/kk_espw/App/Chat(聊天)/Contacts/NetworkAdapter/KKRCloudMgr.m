...
//    //名片群组信息源
//    [RCContactCardKit shareInstance].groupDataSource = self;
//    //群名片信息提供者  获取用户在群组中的名片信息并显示
...
//        [[RCIM sharedRCIM] getConnectionStatus] == ConnectionStatus_Cellular_2G ||
//        [[RCIM sharedRCIM] getConnectionStatus] == ConnectionStatus_Cellular_3G_4G ||
//        [[RCIM sharedRCIM] getConnectionStatus] == ConnectionStatus_WIFI) {
//        return;
//    }
//    
//    //1.执行次数控制
...
//            if (weakSelf.rcConnectCount < 3) {
//                [weakSelf rcConnectService];
//                return ;
//            }
//        }
//        
//        if (weakSelf.rcConnectSuccess == NO && weakSelf.rcConnectCount < 5) {
//            //2,主线程执行
...
//}
//
///** 更新user信息 的本地缓存(包括消息号,消息号没"K_"前缀要加上) */
...
//            NSArray *userSimpleList = resModel.resultDic[@"response"][@"userSimpleList"];
//            for (NSDictionary *dic in userSimpleList) {
//                RCCCUserInfo *cUserInfo = [[RCCCUserInfo alloc]init];
//                cUserInfo.userId = dic[@"userId"];
//                cUserInfo.portraitUri = dic[@"userLogoUrl"];
//                cUserInfo.name = dic[@"loginName"];
//                cUserInfo.displayName = @"";
//                [mArr addObject:cUserInfo];
//            }
//            resultBlock(mArr);
//        }
//    }];
...
//        group.groupName = model.name;
//        group.portraitUri = model.logoUrl;
//        group.number = model.groupMemberNumber;
//        resultBlock(group);
//        return;
//    }
//    
...
//            group.groupName = dbModel.name;
//            group.portraitUri = dbModel.logoUrl;
//            group.number = dbModel.groupMemberNumber;
//            //block
//            resultBlock(group);
//        }else{
//            //赋值
